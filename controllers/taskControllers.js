...
exports.getTasks = async (req, res) => {
  try {
    ...
    res.status(200).json({ tasks, status: true, msg: "Tasks found..." });
  }
  catch (err) {
    console.error(err);
...
exports.putTask = async (req, res) => {
  try {
    ...
    res.status(200).json({ task, status: true, msg: "Task updated..." });
  }
  catch (err) {
    console.error(err);
    return res.status(500).json({ status: false, msg: "Internal Server Error" });
...
exports.getTask = async (req, res) => {
  try {
    ...
    res.status(200).json({ task, status: true, msg: "Task found..." });
  }
  catch (err) {
    console.error(err);
    return res.status(500).json({ status: false, msg: "Internal Server Error" });
...
exports.deleteTask = async (req, res) => {
  try {
    ...
    res.status(200).json({ status: true, msg: "Task deleted..." });
  }
  catch (err) {
    console.error(err);
    return res.status(500).json({ status: false, msg: "Internal Server Error" });
...
exports.postTask = async (req, res) => {
  try {
    ...
    res.status(200).json({ task, status: true, msg: "Task created..." });
  }
  catch (err) {
    console.error(err);
    return res.status(500).json({ status: false, msg: "Internal Server Error" });
